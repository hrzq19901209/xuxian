...
extern NSString * const fontName = @"Avnir-Book";
static const NSString *boldFontName = @"Avnir-black";
static const NSString *semiBoldFontName = @"Avnir-Heavy";
static const NSString *lighterFontName = @"Avnir-Light";
